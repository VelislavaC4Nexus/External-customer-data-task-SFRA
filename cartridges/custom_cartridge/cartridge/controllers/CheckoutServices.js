    ...
    function (req, res, next) {
        ...
        this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
            ...
            if (customer) {
                ...
                if (HookManager.hasHook('app.register.requestCustomerToExternalService')) {
                    result = HookManager.callHook(
                        ...
                        'addCustomersDataFromCheckoutToExternalService',
                        customerIntegrateId,
                ...
                if (HookManager.hasHook('app.register.requestCustomerToExternalService')) {
                    result = HookManager.callHook(
                        'app.register.requestCustomerToExternalService',
                        'addGuestCustomersDataFromCheckoutToExternalService',
                        customerEmail,
                        currentBasket.shipments,
                        billingAddress
                    );
            ...
            if (HookManager.hasHook('app.payment.processor.' + processor.ID.toLowerCase())) {
                ...
                result = HookManager.callHook('app.payment.processor.default', 'Handle');
            }
            ...
            if (HookManager.hasHook('app.payment.form.processor.' + processor.ID.toLowerCase())) {
                HookManager.callHook('app.payment.form.processor.' + processor.ID.toLowerCase(),
                ...
                HookManager.callHook('app.payment.form.processor.default', 'savePaymentInformation');
            }
